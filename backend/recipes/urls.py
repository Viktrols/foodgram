...
urlpatterns = [
    ...
    path('recipes/<int:recipe_id>/favorite/', views.FavoriteViewSet.as_view(), name='favorite'),
    path('recipes/<int:recipe_id>/shopping_cart/', views.ShoppingListViewSet.as_view(), name='shopping_cart'),
